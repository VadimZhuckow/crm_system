...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $mysql->query("UPDATE tasks SET ");

    // header('location:tasks.php');
    }
?>
<a href="task_view.php?id=<?=$id?>">Вернутся</a>
    <div class="container">
        <form action="task_edit.php?id=<?=$current_task['id']?>" method="POST">
            <label>Название задачи</label>
            <input type="text" placeholder="<?=$current_task['title']?>" name="title"><br>
            <label>Описание задачи</label><br>
            <textarea name="description" placeholder="<?=$current_task['description']?>"></textarea><br>
